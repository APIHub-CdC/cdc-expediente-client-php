...
class RequestExportProceedings implements ModelInterface, ArrayAccess
{
    const DISCRIMINATOR = null;
    
    protected static $apihubModelName = 'RequestExportProceedings';
    ...
    {
        if (($folio > 999999)) {
            throw new \InvalidArgumentException('invalid value for $folio when calling RequestExportProceedings., must be smaller than or equal to 999999.');
        }
